...
public class ItemRepositoryCustomImpl implements ItemRequestRepositoryCustom {

    private final ItemRequestRepository itemRequestRepository;

    private static final String ITEM_REQUEST_NOT_FOUND_TEMPLATE = "Item request with id %d not found";

    public ItemRepositoryCustomImpl(@Lazy ItemRequestRepository itemRequestRepository) {
