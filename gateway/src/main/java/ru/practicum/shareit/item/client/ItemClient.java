...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> getItem(long userId, int id) {
    ...
    public ResponseEntity<Object> updateItem(ItemDto itemDto, int id, Long userId) {
        return patch("/" + id, userId, itemDto);
    }

    public ResponseEntity<Object> addComment(int id, Long userId, CommentDto commentDto) {
